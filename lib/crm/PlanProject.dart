...
class PlanProject extends StatefulWidget {
  PlanProject({Key? key, required this.appointments}) : super(key: key);
  final List<CalendarDateObject> appointments;

  @override
  State<PlanProject> createState() => _PlanProjectState();
}

class _PlanProjectState extends State<PlanProject> {
  ...
  void initState() {
    ...
    _selectedEvents = ValueNotifier(widget.appointments);
  }
